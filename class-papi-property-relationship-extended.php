...
/**
 * Papi Property Relationship Extended.
 *
 * @package Papi
 * @since 1.0.0
 */

class Papi_Property_Relationship_Extended extends Papi_Property {
                            ...
                            if ( ! empty( $post->post_title ) ):
                                ...
                                <li>
                                    <?php if( has_post_thumbnail($post->ID) ): ?>
                                        <img src="<?=wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'width=100&height=100&crop=0' )[0];?>" alt="">
                                    <?php endif;?>
                                    <input type="hidden" data-name="<?php echo $options->slug; ?>[]"
                                           value="<?php echo $post->ID; ?>"/>
                                    <a href="#"><?php echo qtranxf_useCurrentLanguageIfNotFoundUseDefaultLanguage( $post->post_title ); ?></a>
